...
const mensaje = `أنت محظور/ة، لا يمكنك استخدام الأوامر في هذا البوت\n\n السبب: ${user.bannedReason}\n\n إذا كان هذا البوت حسابًا رسميًا ولديك دليل يثبت أن هذا الحظر تم عن طريق الخطأ، يمكنك عرض حالتك على أحد المشرفين.`.trim()
m.reply(mensaje)
return
}}
...
const msg = {
  retirado: '📛 هذا الأمر مخصص فقط للمالكين المتقاعدين من البوت.',
  rowner: '*˙˚ʚ₍ ᐢ.👑.ᐢ ₎ɞ˚ هذا الأمر مخصص فقط للمالك الرئيسي للبوت.*',
  owner: '*˙˚ʚ₍ ᐢ.👤.ᐢ ₎ɞ˚ هذا الأمر مخصص فقط لمالك البوت.*',
  mods: '*˙˚ʚ₍ ᐢ.🍃.ᐢ ₎ɞ˚ هذا الأمر مخصص فقط للمشرفين المعينين من قبل المالك.*',
  premium: '*˙˚ʚ₍ ᐢ.💎.ᐢ ₎ɞ˚ هذا الأمر مخصص فقط للمستخدمين المميزين (Premium).*',
  group: '*˙˚ʚ₍ ᐢ.📚.ᐢ ₎ɞ˚ هذا الأمر يعمل فقط داخل المجموعات.*',
  private: '*˙˚ʚ₍ ᐢ.📲.ᐢ ₎ɞ˚ هذا الأمر يعمل فقط في الدردشة الخاصة مع البوت.*',
  admin: '*˙˚ʚ₍ ᐢ.🔱.ᐢ ₎ɞ˚ هذا الأمر مخصص فقط لمشرفي المجموعة.*',
  botAdmin: '*˙˚ʚ₍ ᐢ.🌟.ᐢ ₎ɞ˚ لتنفيذ هذا الأمر، يجب أن يكون البوت مشرفًا في المجموعة.*',
  unreg: '*˙˚ʚ₍ ᐢ.📋.ᐢ ₎ɞ˚ تحتاج إلى التسجيل أولًا لاستخدام هذا الأمر. اكتب #تسجيل لتسجيل نفسك.*',
  restrict: '*˙˚ʚ₍ ᐢ.⚙️.ᐢ ₎ɞ˚ هذا الأمر مقيد ويجب تفعيله من قبل مالك البوت.*'
}[type];
